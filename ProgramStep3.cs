...
{
    /// <summary>
    /// Fiksa rare rettinger, men den klarer ikke å lage rom som har riktig kobling til hverandre.
    /// </summary>
    class Room
    {
        public string Name;
    ...
    class Game
    {
        public static void Main(string[] args)
        {
            ...
            Room[] randomRooms = {
            new Room("Random Room 0", "You are in a dark room.", 2, 50, false),
            new Room("Random Room 1", "You are in a dusty room.", 3, 100, false),
            new Room("Random Room 2", "You are in a damp room.", 1, 25, false),
            new Room("Random Room 3", "You are in a cold room.", 0, 200, false),
            new Room("Random Room 4", "You are in a hot room.", 5, 150, false)
        };
